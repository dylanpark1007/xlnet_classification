...
class BertLearner(object):
    ...
    def from_pretrained_model(dataBunch, pretrained_path, output_dir, metrics, device, logger, finetuned_wgts_path=None, 
                              multi_gpu=True, is_fp16=False, loss_scale=0, warmup_steps=0, fp16_opt_level='O1',
                              grad_accumulation_steps=1, multi_label=False, max_grad_norm=1.0, adam_epsilon=1e-8, 
                              logging_steps=100000): #default : logging_steps=100
    ...
    def __init__(self, data: BertDataBunch, model: nn.Module, pretrained_model_path, output_dir, metrics, device,logger,
        ...
        self.logging_steps = 250 #logging_steps
        self.max_steps = -1
    ...
    #     set_seed(args)
        ...
        for epoch in pbar:
            ...
            print('processing time:', str(datetime.timedelta(seconds=time_consumed)))
            self.validate()
    ...
    def save_model(self): 
        ...
        path = '/hdd/user4/xlnet_classification/output/model_out/'
