...
databunch = BertDataBunch(data_dir ='/hdd/user4/xlnet_classification3/dataset',
                          label_dir = '/hdd/user4/xlnet_classification3/dataset',
                          tokenizer='xlnet-base-cased',
                          train_file='ag_news_train.csv',
                          val_file='ag_news_test.csv',
                          label_file='ag_news_labels.csv',
                          text_col='text',
                          label_col='label',
                          batch_size_per_gpu=32, #default=16
...
#
# MODEL_PATH = '/hdd/user4/xlnet_classification/output/model_out'
# LABEL_PATH = '/hdd/user4/xlnet_classification/dataset'
#
...
# with open('/hdd/user4/xlnet_classification3/dataset/cnn_data(subsamples)/odp.wsdm.train.25310','r') as f:
#     a = f.readlines()
# label_data = []
# text_data = []
# for line in a:
#     sent = line.split(' ')
#     label = sent[0]
#     text = (' ').join(sent[1::]).strip()
#     label_data.append(label)
#     text_data.append(text)
#
# import pickle
# with open('/hdd/user4/xlnet_classification3/dataset/cnn_data(subsamples)/cnn_data/NYTlabel_dict.pkl','rb') as f:
#     k = pickle.load(f)
#
# rev_k = {}
# for p, v in k.items():
#     rev_k[int(v)] = int(p)
#
# label_data2 = [rev_k[int(j)] for j in label_data]
#
# import pandas as pd
#
# df = pd.DataFrame(data=text_data , columns = ['text'])
# df['label']=label_data2
# df.to_csv('/hdd/user4/xlnet_classification3/dataset/cnn_data(subsamples)/train_converted_25310.csv')
